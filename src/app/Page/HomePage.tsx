    ...
    <div className="flex flex-col md:flex-row md:h-full mb-24 md:mb-48">
      <div className="w-full md:h-full flex flex-col md:w-1/2 p-4 md:p-12 text-center md:text-left">
        ...
        <div className="flex-grow flex flex-col justify-center gap-4 md:gap-7 p-4 md:p-12">
          <h1 className="text-2xl sm:text-3xl md:text-5xl text-[var(--font-rosa-title)] font-bold italic leading-tight">
            TREINE COM A ISA
          </h1>
          <p className="text-base sm:text-lg md:text-2xl font-semibold text-[var(--font-rosa-paragraph)] mt-2 md:mt-4">
            Transforme seus objetivos em resultados reais, com suporte
            especializado.
          </p>
          <p className="text-[var(--font-rosa-paragraph)] mt-2 md:mt-4 text-pretty text-base sm:text-lg md:text-xl">
